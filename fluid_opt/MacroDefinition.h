...
#define GRID_X                64    // 计算网格在单维度上所拥有的数量
#define SLOT_X                66    // 单独的计算节点并不能直接用于流体计算，必须放入slot后才可以
#define NODE_X                 3    // 计算节点在单维度上所拥有的数量
#define VOLUME_X    GRID_X*NODE_X   // 三维体数据在单维度上的长度
#define THREAD_X            1024    // 定义CUDA的线程数量
