...
#define VOLUME_X            192    // 三维体数据在单维度上的长度
#define THREADS_X           512    // 定义NVidia的CUDA显卡应该拥有的线程数量，512是F10的标准值
...
#define TPBUFFER_X          1024   // 为了可移植性而创建的临时数据缓存，用于替代CUDA编程里常用的shared memories
