...
extern __global__ void kernelJacobi( double *grid_out, cdouble *grid_in, cdouble diffusion, cdouble divisor );

extern __global__ void kernelGridAdvection( double *grid_out, cdouble *grid_in, cdouble deltatime, cdouble *u_in, cdouble *v_in, cdouble *w_in );

extern __global__ void kernelSumDensity( double *share, cdouble *src, cint no );

extern __global__ void kernelGridAdvection( double *grid_out, cdouble *grid_in, cdouble deltatime, cdouble *u_in, cdouble *v_in, cdouble *w_in );

extern __global__ void kernelGradient( double *div, double *p, cdouble *vel_u, cdouble *vel_v, cdouble *vel_w );

extern __global__ void kernelSubtract( double *vel_u, double *vel_v, double *vel_w, cdouble *p );
...
extern __global__ void kernelHandleHalo( double *center, cdouble *left, cdouble *right, cdouble *up, cdouble *down, cdouble *front, cdouble *back );
